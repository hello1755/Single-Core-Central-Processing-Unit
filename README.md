In the final project, we designed a single core CPU with the functionality below, after finishing all the RTL design, we also run APR to complete the IC design flow 
